...
def discriminator_given_video_fn(targets, hparams):
    ...
    if hparams.image_sn_gan_weight or hparams.image_sn_vae_gan_weight:
        with tf.variable_scope('image'):
            image_features = networks.patch_image_sn_discriminator(image_sample, ndf=hparams.ndf)
    ...
    if hparams.images_sn_gan_weight or hparams.images_sn_vae_gan_weight:
        with tf.variable_scope('images'):
            images_features = tf_utils.with_flat_batch(networks.patch_image_sn_discriminator)(clip_sample, ndf=hparams.ndf)
